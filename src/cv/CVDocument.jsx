...
const styles = StyleSheet.create({
  ...
  contactRow: { fontSize: 9, color: '#566075', textAlign: 'center', marginBottom: 14 },
...
const CVDocument = ({ resume }) => {
  const personal = resume?.personal ?? canonical.personal;
  const summary = resume?.summary ?? canonical.summary;
  const skillNames = resume?.skillNames ?? canonical.skillNames;
